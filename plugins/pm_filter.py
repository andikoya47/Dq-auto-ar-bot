            ...
            if manual == False:
                ...
                try:
                    if settings['auto_ffilter']:
                        ...
                        await client.delete_messages(message.chat.id, st_msg.message.id)
                except KeyError:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("𝖠𝗋𝖾 𝗒𝗈𝗎 𝗂𝗇𝗌𝗂𝗇𝗎𝖺𝗍𝗂𝗇𝗀 𝖿𝗈𝗈𝗅𝗂𝗌𝗁𝗇𝖾𝗌𝗌...? 𝖸𝗈𝗎 𝖼𝖺𝗇𝗇𝗈𝗍 𝗎𝗍𝗂𝗅𝗂𝗓𝖾 𝗍𝗁𝗂𝗌 𝖿𝖾𝖺𝗍𝗎𝗋𝖾 𝖺𝗌 𝗂𝗍 𝗂𝗌 𝖾𝗑𝖼𝗅𝗎𝗌𝗂𝗏𝖾𝗅𝗒 𝗋𝖾𝗌𝖾𝗋𝗏𝖾𝖽 𝖿𝗈𝗋 𝖮𝖼𝖾𝖺𝗇𝖢𝗋𝖾𝗐 𝖬𝗈𝗏𝗂𝖾𝗌 𝖺𝖽𝗆𝗂𝗇𝗂𝗌𝗍𝗋𝖺𝗍𝗈𝗋𝗌 ❌", show_alert=True)
